...
var jupiter = parseInt(system.jupiter.satellites)
var saturn = parseInt(system.saturn.satellites)
var uranus = parseInt(system.uranus.satellites)
var naptune = parseInt(system.neptune.satellites)
var sum = jupiter + saturn + uranus + naptune
console.log(sum)
...
var jupiterMomentum = parseInt(system.jupiter.velocity).toFixed(3) * parseInt(system.jupiter.mass).toFixed(3)
var plutoMomentum = parseInt(system.pluto.velocity).toFixed(3) * parseInt(system.pluto.mass).toFixed(3)
var difference = jupiterMomentum - plutoMomentum
